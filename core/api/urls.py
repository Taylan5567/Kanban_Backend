...
from .views import BoardListView, EmailCheckView, MyTasksAssignedView, TaskCreateView, BoardDetailsView, MyTasksReviewsView, MyTaskDetailsView, CommentView, CommentDetailView
